...
   };
    ...
    function init_table(){
       detail_tableIns =  table.render({
          ...
          ,page: true
          ,cols: [[
              ,{field:'report_name', width:150, title: '财报名称', sort: true, fixed: 'left'}
              ,{field:'type',width:80, title: '类型', sort: true}
              ,{field:'period', title: '统计时段', sort: true}
              ,{field:'own_name', width:150, title: '个人名称'}
              ,{field:'career', width:80, title: '职业', sort: true,}
              ...
              ,{field:'create_date', width:80, title: '创建日期', sort: true}
